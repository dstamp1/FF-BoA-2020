...
### In your breakout rooms, 1) write a route called '/random' that display a random jeopardy clue using the Jservice API. As a strength, being to style it using a card.


#### So now we have an app that we want to deploy for others to access. Right now, we need to access via Cloudshelll ina  "local" way. Pushing to a service like heroku lets us send it to our friends and family!
